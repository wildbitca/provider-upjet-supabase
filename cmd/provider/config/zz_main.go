...
func main() {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-upjet-supabase-config",
		Cache: cache.Options{
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_config(mgr, clusterOpts), "Cannot setup cluster-scoped UpjetSupabase controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_config(mgr, namespacedOpts), "Cannot setup namespaced UpjetSupabase controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_config(mgr, clusterOpts), "Cannot setup cluster-scoped UpjetSupabase controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_config(mgr, namespacedOpts), "Cannot setup namespaced UpjetSupabase controllers")
	}
