...
func main() {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-upjet-supabase-project",
		Cache: cache.Options{
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated_project(mgr, clusterOpts), "Cannot setup cluster-scoped UpjetSupabase controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated_project(mgr, namespacedOpts), "Cannot setup namespaced UpjetSupabase controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup_project(mgr, clusterOpts), "Cannot setup cluster-scoped UpjetSupabase controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup_project(mgr, namespacedOpts), "Cannot setup namespaced UpjetSupabase controllers")
	}
