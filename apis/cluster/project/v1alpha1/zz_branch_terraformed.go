...
func (mg *Branch) GetTerraformResourceType() string {
	return "supabase_branch"
}

// GetConnectionDetailsMapping for this Branch
func (tr *Branch) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"database.jwt_secret": "status.atProvider.database.jwtSecret", "database.password": "status.atProvider.database.password"}
}
